...
预设照抄官方原文, 仅做三类加工: 按项目规范转换标点; 修正官方原文自带的笔误
(错别字, 缺失引号, 重复示例等); 英译中 - Edit 系列与 Flux.2 共 5 个预设
(QWEN_IMAGE_EDIT 系列三个与 FLUX2_T2I/FLUX2_I2I)的官方原文为英文, 已译为中文,
其中 Flux.2 两条另注入 "输出必须为英文" 的规则(原文无).
与上游原文逐字比对出现差异时以此为解释, 非本项目抄写错误.
"""
