...
# dict 声明顺序即 UI 下拉框顺序(loader 侧在首位另置 "None" 占位作默认值,
# 见 node_loaders.py), 排序约定: 同家族聚组, 组内按模型发布时间从新到旧;
# 常用家族在前, OCR/文档专用类居中, 早期模型在后, -Generic- 兜底收尾.
_HANDLER_SPECS = {
    # ---- Qwen ----
    ...
    # E2B/E4B 实测: 传 False 安全, 但 E 系列关不掉思考(仍以纯文本思考并输出
